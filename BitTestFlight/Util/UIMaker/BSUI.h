...
/**
 ...
 @return UIButton
 */
UIButton *InsertImageButton(id _Nullable superView, UIImage *image, int tag, id target, SEL _Nullable action, ConstraintMaker _Nullable make);
...
/**
 ...
 @return UIImageView
 */
UIImageView *InsertImageView(id _Nullable superView, UIImage *image, ConstraintMaker _Nullable make);
