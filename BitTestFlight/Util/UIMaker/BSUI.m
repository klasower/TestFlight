...
UIButton *InsertImageButton(id superView, UIImage *image, int tag, id target, SEL action, ConstraintMaker make) {
    UIButton *button = [UIButton buttonWithType:UIButtonTypeCustom];
...
UIImageView *InsertImageView(id superView, UIImage *image, ConstraintMaker make) {
